import { VendorDetails } from "@/hooks/useVendorDetails";

export const MOCK_VENDORS: Record<string, VendorDetails> = {
  // Shipping Lines
  "hapag-lloyd": {
    id: "hapag-lloyd",
    name: "HAPAG-LLOYD (AMERICA) LLC",
    address: "3 RAVINIA DRIVE SUITE 1600 ATLANTA, GA 30346 USA",
    phone: "1 855 227-4612",
    type: "shipping",
    customFields: [
      {
